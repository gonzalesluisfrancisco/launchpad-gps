...
/* GPIO for SSI pins */
#define SDC_SSI_GPIO_PORT_BASE   GPIO_PORTD_BASE
/* CLK pin */
...
static
void SELECT(void) {
	ROM_GPIOPinWrite(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_FSS, 0);
}

/* de-asserts the CS pin to the card */
static
void DESELECT(void) {
	ROM_GPIOPinWrite(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_FSS, SDC_SSI_FSS);
}
...
void send_initial_clock_train(void) {
	...
	ROM_GPIOPinTypeGPIOOutput(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_TX);
	ROM_GPIOPinWrite(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_TX, SDC_SSI_TX);
	...
	ROM_GPIOPinTypeSSI(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_TX);
}
...
void power_on(void) {
	 ...
	 */
	ROM_GPIOPinTypeSSI(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_TX);
	ROM_GPIOPinTypeSSI(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_RX);
	ROM_GPIOPinTypeSSI(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_CLK);
	ROM_GPIOPinTypeGPIOOutput(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_FSS);

	/*
	 * Set the SSI output pins to 4MA drive strength and engage the
	 * pull-up on the receive line.
	 */
	MAP_GPIOPadConfigSet(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_RX,
	GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD_WPU);
	MAP_GPIOPadConfigSet(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_CLK,
	GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD);
	MAP_GPIOPadConfigSet(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_TX,
	GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD);
	MAP_GPIOPadConfigSet(SDC_SSI_GPIO_PORT_BASE, SDC_SSI_FSS,
	GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD);
